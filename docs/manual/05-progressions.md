...
- **Name** — the progression name (e.g., "Pop", "Jazz ii-V-I").
- **Roman numeral degrees** — the scale degrees used (e.g., I - V - vi - IV).
- **Chord chips** — the actual chord names in your selected key. Tap any chip to jump to its voicings in the Chord Library.
